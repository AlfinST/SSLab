    ...
    while(1)
    {
        ...
        switch(ch)
        {
                case 1:
                            ...
                            if( !(strcmp((*NowRoot).data.PresentName,MasterRoot.data.PresentName))) 
                                {  
                                    printf("In Master Node\n");
                                    makeADirectory();                        
                                    printf("Directory created ,(%d)",dcnt); 
                                }
                            else if (!strcmp(((*NowRoot).parent)->data.PresentName,MasterRoot.data.PresentName))
                                {
                                    printf("Parent is Master Node\n");
                                    makeADirectory();    
                                    printf("Directory created ,(%d)",dcnt);
                                }
                            else
                                {
                                    printf("This is a 2 Level Directory! \n");
                                }
                ...
                case 2:
                        if( (!strcmp((*NowRoot).data.PresentName,MasterRoot.data.PresentName))) 
                            {
                                printf("create a directory and use that!\n");     
                            }
                        else
                        {
